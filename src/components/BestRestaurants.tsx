...
const RestaurantCard = ({ name, image, rating, reviews, category, time, price }: { 
  name: string, 
  image: string, 
  rating: number, 
  reviews: number,
    ...
    <section className="py-20 px-6 lg:px-20">
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-between items-center mb-14">
          <h2 className="text-4xl font-bold">12 Best Restaurants In Your City</h2>
